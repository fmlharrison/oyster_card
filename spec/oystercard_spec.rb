...
describe Oystercard do
  ...
  context "Card balance and topping up" do
  ...
  describe "touching out" do
    ...
    it "re-sets the entry station after touch out" do
      topped_up_card.touch_in(station)
      topped_up_card.touch_out(station)
      expect(topped_up_card.current_journey[:entry_station]).to be nil
    end

    it "re-sets the exit station after touch out" do
      topped_up_card.touch_out(station)
      expect(topped_up_card.current_journey[:exit_station]).to eq nil
    end
  end
